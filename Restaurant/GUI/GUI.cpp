...
void GUI::PrintMessage(string msg , int Line) const	//Prints a message on status bar
{
	...
	pWind->DrawString(10, WindHeight - (int) (StatusBarHeight/1.5)+(17*Line), msg); // You may need to change these coordinates later 
...
//////////////////////////////////////////////////////////////////////////////////////////
void GUI::DrawSingleOrder(const Order* pO, int RegionCount) const       // It is a private function
{
...
*/
void GUI::AddOrderForDrawing(const Order* ptr)
{
